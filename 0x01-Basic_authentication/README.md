...
+ [x] 0. **Simple-basic-API**
  + Setup and start server:
    ```powershell
    amann@Amanns:~$ pip3 install -r requirements.txt
    ...
    amann@Amanns:~$
    amann@Amanns:~$ API_HOST=0.0.0.0 API_PORT=5000 python3 -m api.v1.app
  ...
  + Use the API (in another tab or in your browser):
    ```powershell
    amann@Amanns:~$ curl "http://0.0.0.0:5000/api/v1/status" -vvv
    *   Trying 0.0.0.0...
    * TCP_NODELAY set
